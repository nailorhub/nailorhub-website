...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-[#0a1628]">
      ...
      {/* Centered content */}
      <div className="relative flex-1 flex flex-col items-center justify-center max-w-3xl mx-auto w-full px-6 lg:px-8 pt-8 md:pt-12 pb-2">
        {/* Text content - centered */}
          ...
          <motion.div
            ...
            transition={{ delay: 0.2 }} className="bg-blue-500/5 mb-5 px-4 py-2 opacity-50 rounded-full inline-flex items-center gap-2 border border-blue-500/10">
            ...
            <span className="text-blue-300/60 pl-3 text-sm font-medium tracking-wide">Currently focused on internal projects</span>
          </motion.div>
